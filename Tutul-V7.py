...
ua = ["Mozilla/5.0 (Linux; U; Android 7.1.0; zh-cn; ONEPLUS A35904 Build/PKQ1.180716.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.132 MQQBrowser/9.2 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 12; CPH2469 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.162 Mobile Safari/537.36",]
...
def passwrd():
    ...
    print('\n\033[1;37m===================================')
    woi = input('\033[97;1m[\033[92;1m+\033[97;1m] \033[1;37m ENTER TO BACK TUTUL Menu')
    #os.system("python nono.py")
    exit()
